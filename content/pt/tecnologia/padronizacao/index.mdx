...
Consulte também a página de [licenças de software](/licencas) para ver as dependências públicas usadas no site.
...
- [Padronização para web](/docs/tecnologia/padronizacao/web): recomendações para sites, portais, aplicações web e integrações ao ambiente digital da Elinsa.
