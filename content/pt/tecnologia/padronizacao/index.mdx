---
title: "Padronização"
description: "Critérios gerais para que soluções digitais da Elinsa sejam seguras, mantidas pela empresa e fáceis de evoluir."
---

Padronização é o conjunto de critérios que a Elinsa usa para transformar ideias digitais em soluções seguras, mantidas pela empresa e fáceis de evoluir.
...
O objetivo não é limitar ideias ou desestimular quem propõe melhorias. É garantir que uma ferramenta útil não fique presa a uma pessoa, a uma conta pessoal, a uma licença restritiva, a uma tecnologia fechada sem alternativa de manutenção ou a um fornecedor difícil de substituir.
...
Todo material técnico ou código interno que possa ser usado por uma área da empresa deve passar por revisão da TI antes de entrar em produção[^producao]. Essa revisão ajuda a confirmar segurança, continuidade, licenças, dados envolvidos e forma correta de implantação.
...
Na prática, a padronização protege quatro pontos:
...
Na prática, isso significa que a solução precisa deixar de depender do controle individual de quem a criou. A Elinsa deve conseguir acessar, revisar, executar, atualizar, corrigir e, se necessário, substituir a solução sem depender de autorização pessoal futura.
...
Open source[^open-source], ou código aberto, é um modelo em que o código de uma tecnologia pode ser lido, estudado, revisado e, dependendo da licença[^licenca], adaptado por outras pessoas. Na prática, isso significa que a empresa consegue entender melhor o que está usando, verificar a licença, acompanhar correções de segurança e trocar de fornecedor ou equipe sem ficar presa a uma caixa-preta.
...
Preferir open source ajuda a empresa a:

- revisar como uma biblioteca funciona antes de colocá-la em produção;
- corrigir ou substituir partes da solução quando necessário;
- evitar dependência excessiva de um único fornecedor;
- aproveitar conhecimento da comunidade técnica;
- reduzir risco de licenças obscuras, custos inesperados ou bloqueio de acesso.
...
As páginas abaixo detalham recomendações por tipo de solução:

- [Padronização para web](./web): recomendações para sites, portais, aplicações web e integrações ao ambiente digital da Elinsa.
